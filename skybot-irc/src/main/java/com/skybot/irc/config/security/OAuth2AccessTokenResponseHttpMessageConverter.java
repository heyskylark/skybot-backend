...
public class OAuth2AccessTokenResponseHttpMessageConverter extends AbstractHttpMessageConverter<OAuth2AccessTokenResponse> {
    ...
    protected Converter<Map, OAuth2AccessTokenResponse> tokenResponseConverter =
...
//            JsonNode tokenResponseParameters = (JsonNode) this.jsonMessageConverter.read(
//                    PARAMETERIZED_RESPONSE_TYPE.getType(), null, inputMessage);
            ObjectMapper mapper = new ObjectMapper();
            Map tokenResponseParameters = mapper.readValue(inputMessage.getBody(), Map.class);
     ...
     */
    public final void setTokenResponseConverter(Converter<Map, OAuth2AccessTokenResponse> tokenResponseConverter) {
     ...
     */
    private static class OAuth2AccessTokenResponseConverter implements Converter<Map, OAuth2AccessTokenResponse> {
        ...
        public OAuth2AccessTokenResponse convert(Map tokenResponseParameters) {
            ...
            if (tokenResponseParameters.containsKey(OAuth2ParameterNames.SCOPE)) {
                List<String> scope = (List<String>) tokenResponseParameters.get(OAuth2ParameterNames.SCOPE);
